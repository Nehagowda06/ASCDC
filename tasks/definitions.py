...
TASKS: Dict[str, Dict[str, Any]] = {
    "T1_INCIDENT_RESPONSE": {
        "name": "Firestorm",
        "description": "Immediate overload at service B",
        "config": {
            "seed": 42,
            "base_load": {
                "A": 30.0,
    ...
    "T2_CAPACITY_PLANNING": {
        "name": "Slow Leak",
        "description": "Delayed overload due to slight imbalance",
        "config": {
            "seed": 43,
            "base_load": {
                "A": 10.5,
    ...
    "T3_STABILITY_PRESERVATION": {
        "name": "Ghost Spike",
        "description": "Transient spike that resolves without intervention",
        "config": {
            "seed": 44,
            "base_load": {
                "A": 10.0,
