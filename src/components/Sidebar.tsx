...
export function Sidebar({ activePage, items, onNavigate }: SidebarProps) {
  return (
    <>
      <aside className="fixed inset-x-0 top-0 z-20 border-b border-gray-200 bg-white md:inset-y-0 md:left-0 md:w-[240px] md:border-b-0 md:border-r">
        <div className="flex h-full flex-col">
          <div className="border-b border-gray-200 p-6">
            <p className="text-lg font-medium text-gray-900">ASCDC</p>
            <p className="mt-1 text-sm text-gray-500">OpenEnv dashboard</p>
          </div>
